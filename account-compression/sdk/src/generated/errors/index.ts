...
/**
 * InvalidProofBufferOwner: 'Invalid proof buffer owner'
 *
 * @category Errors
 * @category generated
 */
export class InvalidProofBufferOwnerError extends Error {
    readonly code: number = 0x177b;
    readonly name: string = 'InvalidProofBufferOwner';
    constructor() {
        super('Invalid proof buffer owner');
        if (typeof Error.captureStackTrace === 'function') {
            Error.captureStackTrace(this, InvalidProofBufferOwnerError);
        }
    }
}

createErrorFromCodeLookup.set(0x177b, () => new InvalidProofBufferOwnerError());
createErrorFromNameLookup.set('InvalidProofBufferOwner', () => new InvalidProofBufferOwnerError());

/**
 * ProofBufferMaxDepthMismatch: 'Proof buffer max depth mismatch'
 *
 * @category Errors
 * @category generated
 */
export class ProofBufferMaxDepthMismatchError extends Error {
    readonly code: number = 0x177c;
    readonly name: string = 'ProofBufferMaxDepthMismatch';
    constructor() {
        super('Proof buffer max depth mismatch');
        if (typeof Error.captureStackTrace === 'function') {
            Error.captureStackTrace(this, ProofBufferMaxDepthMismatchError);
        }
    }
}

createErrorFromCodeLookup.set(0x177c, () => new ProofBufferMaxDepthMismatchError());
createErrorFromNameLookup.set('ProofBufferMaxDepthMismatch', () => new ProofBufferMaxDepthMismatchError());
